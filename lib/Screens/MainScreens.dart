...
class _MainScreensState extends State<MainScreens> {
  ...
  late String trigger = "Motivasi By All";
  // late String triggeruser;//di hapus sementara
  @override
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 30), // <-- Kasih Jarak Tinggi : 50px
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          onPressed: () async {
                            ...
                            } else if (isiController.text.toString().isEmpty) {
                              await sendMotivasi(
                    ...
                    trigger == "Motivasi By User"
                        ? FutureBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              } else if (snapshot.hasError) {return Text("${snapshot.hasError}");} else {
                                return Text("No Data");
                              }
                            })
                        : Container(),
